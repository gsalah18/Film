...
<button type="submit"><i class="fa fa-search"></i></button>
    ...
    <section id="movies" class="movies  row  position-relative">
        <input type="checkbox" name="" id="checkFilter">
        <div class="movie__tool">
            <div></div>
        </div>
        <div class="movies__categories col-lg-3  ">
            <div class="movies__categories_type">

                <hr>
                <div class="movies__categories__byYear ">
                    <h2>TVshow by Year</h2>
                    <ul>
                        <li>
        ...
        <div class="movies__filter col-lg-9 ">
            ...
            <div class="movies__filter__deitails" id="result">
                ...
                <!-- movie item -->
                <div class="movies__filter__deitails__item">
                    <div>
                        <img src="images/51-walk-hard-300x450.jpg" alt="">
                        <div>
                            <small>2021 | Egypt</small>
                            <strong>movie name</strong>
                            <small>movie type</small>
                            <a class="btn btn-outline-dark" href="details.html">read more</a>
                        </div>
                    </div>
                </div>
            </div>
        </div>
        <div class="Top5List col-lg-3 ">
            <h2>Top 5 List</h2>
            <hr>
    ...
    <d iv class="modal " id="loginModal" data-backdrop="static" data-keyboard="false" tabindex="-1"
                    ...
                    <form action="/film/includes/addUser.php" enctype="multipart/form-data" method="post">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control form-control-sm" name="userPass"
                                    id="userPass" required="required" aria-describedby="helpId" placeholder="">
                            </div>
                            <div class="form-group">
