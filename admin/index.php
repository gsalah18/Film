              ...
              <i class="fas fa-search fa-fw"></i>
               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                    <a href="pages/forms/admin.php" class="nav-link">
                            ...
                            <li class="nav-item">
                                    <a href="pages/forms/cats.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add category</p>
                                    </a>
                                </li>
                            ...
                            <li class="nav-item">
                                    <a href="pages/forms/video.php" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add video</p>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a href="pages/tables/shopKeeperData.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>shopKeeper Data</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="pages/tables/adminData.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>admin Data</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="pages/tables/videoData.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>video Data</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="pages/tables/userData.php" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>user Data</p>
                                        </a>
                                    </li>
