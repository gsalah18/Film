        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Shopkeeper Data Table</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= AURL ?>index.php">Home</a></li>
                                <li class="breadcrumb-item active">Shopkeeper Data Table</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                  ...
                  while($shopkeeperData = mysqli_fetch_assoc($data)){
                    ...
                    ?>
                     <tr>
                         ...
                         <td>
                          <a href="<?= AURL ?>handlers/delete-shop.php?id=<?= $shopkeeperData['id']; ?>" class=" btn-outline-danger">delete</a>
                           </td>
                    </tr> <?php } ?>*/
    
  // search shopkeeper code //
                    
  if(isset($_GET['name'])){
    $filterValue = $_GET['name'];
    $sql= "SELECT * FROM shopkeeper WHERE name LIKE '%$filterValue%'";
    ...
    <tr>
        ...
        <td>
            <a href="<?= AURL ?>handlers/delete-user.php?id=<?=$item['id']; ?>" class="btn-outline-danger">delete</a>
        </td>
