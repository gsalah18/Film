                  ...
                  while($videoData = mysqli_fetch_assoc($data)){
                    ?>
                     ...
                     <tr>
                         ...
                         <td>
                          <a href="<?= AURL ?>handlers/edit-video.php?id=<?= $videoData['id']; ?>" class="btn-outline-success" >edit</a>
                           </td>
...
// search video code//
                    if(isset($_GET['name'])){
                        ...
                        $sql= "SELECT * FROM video WHERE name LIKE '%$filterValue%'";
                        ...
                        <tr>
                            ...
                            <td>
                            <a href="<?= AURL ?>handlers/delete-video.php?id=<?= $item['id']; ?>" class="btn-outline-danger">delete</a>
                            </td>
