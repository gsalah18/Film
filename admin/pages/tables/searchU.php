...
if(isset($_GET['name'])){
    ...
    $sql= "SELECT * FROM user WHERE name LIKE '%$filterValue%'";
    ...
    <tr>
        ...
        <td><?php if($item['status']==1){ ?>
            <a href="<?= AURL ?>handlers/update-user-status.php?id=<?= $item['id'] ?>&status=2"
                class="btn btn-success">approved</a>
            <?php } else { ?>
            <a href="<?= AURL ?>handlers/update-user-status.php?id=<?= $item['id'] ?>&status=1"
