            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline" method="get" action="searchS.php">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" type="search" placeholder="Search..."name="name" value="<?php if(isset($_GET['name'])){echo $_GET['name'];}?>"
                                    aria-label="Search">
