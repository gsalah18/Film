            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline"  method="get" action="searchV.php">
                            <div class="input-group input-group-sm">
                                <input class="form-control form-control-navbar" type="search" name="name" placeholder="I'm looking for..."
                                    aria-label="Search">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Video Data Table</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?= AURL ?>index.php">Home</a></li>
                                <li class="breadcrumb-item active">Video Data Table</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <?php
                 $data=selectAll("video");
                  while($videoData = mysqli_fetch_assoc($data)){
                    ?>

                     <tr>
                         <td><?= $videoData['name'] ?></td>
                         <td><?= $videoData['video'] ?></td>
                         <td><?= $videoData['type'] ?></td>
                         <td><?= $videoData['describtion'] ?></td>           
                         <td><?= $videoData['startDate'] ?></td>
                    
                         <td>
                      <?php $_SESSION['vId']=$videoData['id']; ?>

<!-- Button trigger modal -->

<a href="<?= AURL ?>handlers/update-video.php" class="btn-outline-success" data-toggle="modal" data-target="#exampleModal">edit</a>  
...
<form action="<?= AURL ?>handlers/update-video.php" method="post"> 

<div class="form-group">
    <label for="userEmail">name</label>
    <input type="text" class="form-control form-control-sm" name="name" id="name"
        aria-describedby="helpId" required="required" placeholder="video name">
</div>

<div class="form-group">
    <label for="userEmail">poster</label>
    <input type="file" class="form-control form-control-sm" name="poster" id="poster"
        aria-describedby="helpId" required="required" placeholder="poster">
</div>

<div class="form-group">
    <label for="userEmail">describtion</label>
    <input type="text" class="form-control form-control-sm" name="describtion" id="describtion"
        aria-describedby="helpId" required="required" placeholder="describtion">
</div>
      ...
      <div class="modal-footer">
        ...
        <input type="text" name="vId" value="<?= ($_SESSION['vId']) ?>" />
...
<!----------End Modal-------------->
             ...
             <td>
                <a href="<?= AURL ?>handlers/delete-video.php?id=<?= $videoData['id']; ?>" class="btn-outline-danger">delete</a>
             </td>
