            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline" method="get" action="searchA.php">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Admin Data Tables</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                 ...
                 $data=selectAll("admin");
                  while($adminData = mysqli_fetch_assoc($data)){
                    ...
                    ?>
                     ...
                     <tr>
                         ...
                         <td><?php if($adminData['Type']==1){ 
                          ...
                          <td>
                          <a href="<?= AURL ?>handlers/delete-admin.php?id=<?= $adminData['id']; ?>" class="btn-outline-danger">delete</a>
                           </td>
